...
<div id="full">
    <div id="container">
        ...
        <div id="header">
            <div id="sitelogo"><a href="http://www.camacau.com/index" style="color : #FFF;"><img
                    src="./macau_files/cam h04.jpg"></a></div>
            <div id="navcontainer">
                <div id="menu">
                    <div id="search">
                        <form id="searchForm" name="searchForm" action="http://www.camacau.com/search" method="POST">
                            ...
                            <a href="http://www.camacau.com/rssBuilder.action"><img src="./macau_files/rssIcon.png"
                                                                                    alt="RSS">RSS</a>
                        </form>
                    </div>
                </div>
        ...
        <div id="menu2">
            <div>
                ...
                <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="95" height="20" id="FlashID4"
                        title="Main Page">
                    ...
                    <!--[if !IE]>-->
                    <object type="application/x-shockwave-flash" data="http://www.camacau.com/flash/button_index_EN.swf"
                            width="92" height="20">
                        <!--<![endif]-->
                        <param name="quality" value="high">
                        <param name="scale" value="exactfit">
                        ...
                        <div>
                            ...
                            <p><a href="http://www.adobe.com/go/getflashplayer"><img
                                    src="./macau_files/get_flash_player.gif" alt="取得 Adobe Flash Player" width="112"
                                    height="33"></a></p>
                        </div>
                        <!--[if !IE]>-->
                    </object>
                ...
                <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="95" height="20" id="FlashID4"
                    ...
                    <object type="application/x-shockwave-flash"
                            data="http://www.camacau.com/flash/button_our%20business_EN.swf" width="92" height="20">
                        <!--<![endif]-->
                        <param name="quality" value="high">
                        <param name="scale" value="exactfit">
                        <param name="wmode" value="opaque">
                ...
                <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="95" height="20"
                        title="About Us">
                    ...
                    <!--[if !IE]>-->
                    <object type="application/x-shockwave-flash"
                            data="http://www.camacau.com/flash/button_about%20us_EN.swf" width="92" height="20">
                        <!--<![endif]-->
                        <param name="quality" value="high">
                        <param name="scale" value="exactfit">
                        <param name="wmode" value="opaque">
                ...
                <object id="FlashID3" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="95" height="20"
                        title="Media Centre">
                    ...
                    <!--[if !IE]>-->
                    <object type="application/x-shockwave-flash"
                            data="http://www.camacau.com/flash/button_media%20centre_EN.swf" width="92" height="20">
                        <!--<![endif]-->
                        <param name="quality" value="high">
                        <param name="wmode" value="opaque">
                        <param name="scale" value="exactfit">
                ...
                <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="95" height="20" id="FlashID5"
                        title="Related Links">
                    ...
                    <!--[if !IE]>-->
                    <object type="application/x-shockwave-flash"
                            data="http://www.camacau.com/flash/button_related%20links_EN.swf" width="92" height="20">
                        <!--<![endif]-->
                        <param name="quality" value="high">
                        <param name="scale" value="exactfit">
                        <param name="wmode" value="opaque">
                ...
                <object id="FlashID2" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="95" height="20"
                        title="Interactive">
                    ...
                    <!--[if !IE]>-->
                    <object type="application/x-shockwave-flash"
                            data="http://www.camacau.com/flash/button_interactive_EN.swf" width="92" height="20">
                        <!--<![endif]-->
                        <param name="quality" value="high">
                        <param name="scale" value="exactfit">
                        <param name="wmode" value="opaque">
				...
				<param name="expressinstall" value="flash/expressInstall.swf" />
				 下一個物件標籤僅供非 IE 瀏覽器使用。因此，請使用 IECC 將其自 IE 隱藏。 
				[if !IE]>
                <object type="application/x-shockwave-flash" data="flash/button_pressRelease_EN.swf" width="92"
                        height="20">
                <![endif]
				  <param name="quality" value="high" />
				  <param name="scale" value="exactfit">
...
cursor:pointer;
        ...
        <div id="banner">
            ...
            <table id="tbNotice" style="display:none;width:800px;z-index:999;position:absolute;left:20%;"
                   align="center">
                <tbody>
                <tr height="40px">
                    <td></td>
            ...
            <div class="banner1" id="banner1">
                ...
                <a href="http://www.macau-airport.com/" target="_blank" style="display: inline;" id="image4"
                   class="active">
...
a.hiddenajaxlink{display: none}
                    ...
                    <table>
                        <tbody>
                        <tr>
                            <td><img width="20" height="15" src="./macau_files/double.gif"></td>
                            <td><a href="http://www.camacau.com/geographic_information">MIA Geographical Information</a>
                            </td>
                        </tr>
                        <tr>
                            <td><img width="20" height="15" src="./macau_files/double.gif"></td>
                            <td><a href="http://www.camacau.com/airport_services">Scope of Service</a></td>
                        </tr>
                        <tr>
                            <td><img width="20" height="15" src="./macau_files/double.gif"></td>
                            <td><a href="http://www.camacau.com/services_agreement">Air Services Agreement</a></td>
                        </tr>
                        <tr>
                            <td><img width="20" height="15" src="./macau_files/double.gif"></td>
                            <td><a href="http://www.camacau.com/airport_charges" class="leftmenu_silverheader selected"
                                   headerindex="0h"><span>Airport Charges</span></a></td>
                        </tr>
                        <tr>
                            <td colspan="2" style="padding-top:0px;padding-bottom:0px;padding-right:0px;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table class="submenu">
                                                <tbody>
                                                <tr>
                                                    <td><img width="20" height="15" src="./macau_files/sub_icon.gif">
                                                    </td>
                                                    <td><a href="http://www.camacau.com/airport_charges1">Passenger
                                                        Service Fees</a></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td>
                                            <table class="submenu">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="http://www.camacau.com/airport_charges2">Aircraft
                                                        Parking fees</a></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td>
                                            <table class="submenu">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="http://www.camacau.com/airport_charges3">Airport
                                                        Security Fee</a></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td>
                                            <table class="submenu">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="http://www.camacau.com/airport_charges4">Utilization
                                                        fees</a></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td>
                                            <table class="submenu">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="http://www.camacau.com/airport_charges5">Refuelling
                                                        Charge</a></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td>
                                            <table class="submenu">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="http://www.camacau.com/calculation">Calculation of
                                                        Landing fee Rate</a></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </td>
                        ...
                        <tr>
                            <td><img width="20" height="15" src="./macau_files/double.gif"></td>
                            <td><a href="http://www.camacau.com/application_facilities">Application of Credit
                                Facilities</a></td>
                        </tr>
                        <tr>
                            <td><img width="20" height="15" src="./macau_files/double.gif"></td>
                            <td><a href="javascript:void(0)" class="leftmenu_silverheader " headerindex="1h"><span>Passenger Flight Incentive Program</span></a>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" style="padding-top:0px;padding-bottom:0px;padding-right:0px;">
                                        ...
                                        <td>
                                            <table class="submenu">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="http://www.camacau.com/incentive_program1">Incentive
                                                        policy for new routes and additional flights</a></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </td>
                                        ...
                                        <td>
                                            <table class="submenu">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="http://www.camacau.com/incentive_program1_1">Passenger
                                                        flights</a></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td>
                                            <table class="submenu">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="http://www.camacau.com/incentive_program1_2">Charter
                                                        flights</a></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td>
                                            <table class="submenu">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="http://www.camacau.com/docs/MIA_Route_Development_IncentiveApp_Form.pdf"
                                                           target="_blank">Route Development Incentive Application
                                                            Form</a></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td>
                                            <table class="submenu">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="http://www.camacau.com/online_application">Online
                                                        Application</a></td>
                                                </tr>
                                                </tbody>
                                            </table>
                        ...
                        <tr>
                            <td><img width="20" height="15" src="./macau_files/double.gif"></td>
                            <td><a href="http://www.camacau.com/slot_application">Slot Application</a></td>
                        </tr>

                        <tr>
                            <td><img width="20" height="15" src="./macau_files/double.gif"></td>
                            <td><a href="http://www.camacau.com/freighter_forwards">Macau Freight Forwarders</a></td>
                        </tr>
                        <tr>
                            <td><img width="20" height="15" src="./macau_files/double.gif"></td>
                            <td><a href="http://www.camacau.com/ctplatform">Cargo Tracking Platform</a></td>
                        </tr>
                        <tr>
                            <td><img width="20" height="15" src="./macau_files/double.gif"></td>
                            <td><a href="http://www.camacau.com/for_rent">For Rent</a></td>
                        </tr>
                        <tr>
                            <td><img width="20" height="15" src="./macau_files/double.gif"></td>
                            <td><a href="http://www.camacau.com/capacity">Airport Capacity</a></td>
                        </tr>

                        <tr>
                            <td><img width="20" height="15" src="./macau_files/double.gif"></td>
                            <td style="color: #606060;text-decoration: none;"><a href="javascript:void(0)"
                                                                                 class="leftmenu_silverheader "
                                                                                 headerindex="2h">Airport
                                Characteristics &amp; Traffic Statistics</a></td>
                        </tr>
                        <tr>
                            <td colspan="2" style="padding-top:0px;padding-bottom:0px;padding-right:0px;">
                                        ...
                                        <td>
                                            <table class="submenu">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="./macau_files/macau.html">Traffic Statistics -
                                                        Passengers</a></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td>
                                            <table class="submenu">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="http://www.camacau.com/statistics_cargo">Traffic
                                                        Statistics - Cargo</a></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </td>
                        ...
                        <tr>
                            <td><img width="20" height="15" src="./macau_files/double.gif"></td>
                            <td><a href="http://www.camacau.com/operational_routes">Operational Routes</a></td>
                        </tr>
            ...
            <div id="under">
                            ...
                            <div id="Scroller-1">
                                <div class="Scroller-Container">
                                    <div id="statisticspassengers" style="width:550px;">
                                        ...
                                        <br><br><br>
                                        <div align="right"><img src="./macau_files/pass_stat.jpg"
                                                                alt="passenger statistic picture" width="565"
                                                                height="318"></div>
                                        <br><br><br>
                                        ...
                                        <br><br><br>
                                        <div align="right"><img src="./macau_files/mov_stat.jpg"
                                                                alt="passenger statistic picture" width="565"
                                                                height="318"></div>
                ...
                <div id="logo">
                    ...
                    <div>
                        ...
                        <a href="http://www.macau-airport.com/envirop/zh/default.php" style="display: inline;"><img
                                height="80" src="./macau_files/38.jpg"></a>
                    ...
                    <div>
                        ...
                        <a href="http://www.macau-airport.com/envirop/en/default.php" style="display: inline;"><img
                                height="80" src="./macau_files/36.jpg"></a>
...
<div id="___fireplug_chrome_extension___" style="display: none;"></div>
<iframe id="rdbIndicator" width="100%" height="270" border="0" src="./macau_files/indicator.html"
